...
namespace Victoria {
    ...
    public class LavaPlayer : IAsyncDisposable {
        ...
        public LavaPlayer(LavaSocket lavaSocket, IVoiceChannel voiceChannel, ITextChannel textChannel) {
            ...
            Queue = new DefaultQueue<ILavaTrack>();
        ...
        /// </summary>
        /// <param name="track">An instance of <see cref="ILavaTrack" />.</param>
        public async Task PlayAsync(ILavaTrack track) {
            if (track == null) {
        ...
        /// <param name="endTime">Custom end time for track. Must be less than <see cref="ILavaTrack.Duration" />.</param>
        ...
        public async Task PlayAsync(ILavaTrack track, TimeSpan startTime, TimeSpan endTime, bool noReplace = false) {
        ...
        /// <returns>
        ///     The next <see cref="ILavaTrack" />.
        /// </returns>
        public async Task<ILavaTrack> SkipAsync(TimeSpan? delay = default) {
            if (!PlayerState.EnsureState()) {
                throw new InvalidOperationException(
                    "Player state doesn't match any of the following states: Connected, Playing, Paused.");
            }
        ...
        /// </summary>
        /// <param name="position">Position must be less than <see cref="ILavaTrack.Duration" />.</param>
        /// <returns></returns>
