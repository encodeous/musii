...
namespace Victoria.Resolvers {
	...
	public readonly struct LyricsResolver {
		...
		///     <see cref="string" />
		/// </returns>
		/// <exception cref="ArgumentNullException">Throws if ILavaTrack is null.</exception>
		public static async ValueTask<string> SearchGeniusAsync(ILavaTrack lavaTrack) {
			if (lavaTrack == null) {
		...
		/// </returns>
		/// <exception cref="ArgumentNullException">Throws if ILavaTrack is null.</exception>
		public static async ValueTask<string> SearchOVHAsync(ILavaTrack lavaTrack) {
			if (lavaTrack == null) {
				throw new ArgumentNullException(nameof(lavaTrack));
			}
