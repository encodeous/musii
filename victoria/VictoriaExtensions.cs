...
namespace Victoria {
    ...
    public static class VictoriaExtensions {
        ...
        public static ValueTask<string> FetchArtworkAsync(this ILavaTrack track) {
        ...
        /// <param name="track"></param>
        /// <returns><see cref="string"/></returns>
        public static ValueTask<string> FetchLyricsFromGeniusAsync(this ILavaTrack track) {
        ...
        /// <param name="track"></param>
        /// <returns><see cref="string"/></returns>
        public static ValueTask<string> FetchLyricsFromOVHAsync(this ILavaTrack track) {
        ...
        internal static (string Author, string Title) GetAuthorAndTitle(this ILavaTrack lavaTrack) {
