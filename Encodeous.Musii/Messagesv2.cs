...
{
    public static class Messagesv2
    {
        ...
        public static DiscordMessageBuilder PlaylistEmptyMessage(this GuildPlayerManager data)
        {
        ...
        public static DiscordMessageBuilder AddedTrackMessage(this GuildPlayerManager data, LavalinkTrack track)
        {
            return new DiscordMessageBuilder()
                .WithEmbed(new DiscordEmbedBuilder()
        ...
        public static DiscordMessageBuilder AddedTracksMessage(this GuildPlayerManager data, int tracks)
        {
            return new DiscordMessageBuilder()
                .WithEmbed(new DiscordEmbedBuilder()
        ...
        public static DiscordMessageBuilder SaveSessionMessage(this GuildPlayerManager data)
        {
            return new DiscordMessageBuilder()
                .WithEmbed(new DiscordEmbedBuilder()
        ...
        public static DiscordMessageBuilder LockChangedMessage(this GuildPlayerManager data)
        {
        ...
        public static DiscordMessageBuilder QueueSkippedMessage(this GuildPlayerManager data, int skipped)
        {
            return new DiscordMessageBuilder()
                .WithEmbed(new DiscordEmbedBuilder()
        ...
        public static DiscordMessageBuilder PositionSetMessage(this GuildPlayerManager data, TimeSpan pos)
        {
            return new DiscordMessageBuilder()
                .WithEmbed(new DiscordEmbedBuilder()
